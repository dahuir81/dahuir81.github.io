...
source: "https://newsletter.semianalysis.com/p/isscc-2026-nvidia-and-broadcom-cpo?_gl=1*19cc54k*_ga*MzYyNjY4NjIxLjE3NzQ0Mzk0ODQ.*_ga_FKWNM9FBZ3*czE3NzYyOTcyNzkkbzgkZzAkdDE3NzYyOTcyNzkkajYwJGwwJGgxODU4ODIyOTY1"
author:
  - "[[Afzal Ahmad]]"
...
tags:
  - "clippings"
---
### ISSCC 2026 Roundup ISSCC 2026 总结
...
每年有三大半导体大会，分别是 [IEDM](https://newsletter.semianalysis.com/p/interconnects-beyond-copper-1000) 、 [VLSI](https://newsletter.semianalysis.com/p/vlsi2025) ， 最后是 ISSCC。过去几年我们对前两者进行了详细介绍。今天，我们终于用对 ISSCC 2026 的总结来完成这三位一体。
...
与 IEDM 和 VLSI 相比，ISSCC 更侧重于集成和电路。几乎每篇论文都附有某种电路图，以及清晰的测量数据和数据。
...
过去几年，ISSCC 的发现在行业影响方面时好时坏。今年不同，大量论文和演讲直接关联市场趋势。涵盖的主题涵盖了 HBM4、LPDDR6、GDDR7 和 NAND 的最新进展，以及联发科、AMD、英伟达和 Microsoft 等公司的联合光学、先进的芯片接口和先进处理器。
...
在本综述中，我们将涵盖主要类别，如内存、光网络、高速电气互连、处理器。
...
今年 ISSCC 吸引我们注意的一个关键主题是内存，包括三星 HBM4、三星与 SK 海力士 LPDDR6 以及 SK 海力士 GDDR7。除了 DRAM，基于逻辑的 SRAM 和 MRAM 也引起了我们的兴趣。

## Samsung HBM4 - Paper 15.6三星 HBM4 - 纸张 15.6
...
三星是前三大内存厂商中唯一提交 HBM4 技术论文的公司。在 ISSCC 之前，我们在加速 [器和 HBM 模型](https://semianalysis.com/institutional/hbm4-samsung-incremental-progress-micron-execution-risk-rising-hbm3e-pricing-revised-up/) 中提到 ，三星在 HBM4 世代相较 HBM3E 做出了巨大改进。ISSCC 上呈现的数据证实了我们的分析，三星发布了同级最佳性能——我们几个月前也在型号更新说明中详细介绍了这一进展 。  
...
ISSCC 展示的技术细节，结合我们收集到的业内讨论，清楚地表明三星的 HBM4 在同业中具有竞争力。值得注意的是，它可以在保持低于 1V 的同时满足 Rubin 所需的引脚速度。虽然三星在可靠性和稳定性方面仍落后于 SK 海力士，但该公司在技术方面已取得显著进展，有望挑战 SK 海力士在 HBM 市场的主导地位。其基于 1c 的 HBM4 配合 SF4 逻辑基模，在引脚速度方面表现更佳。
...
Samsung HBM3E vs. HBM4 Specifications. Source: Samsung, ISSCC 2026 三星 HBM3E 与 HBM4 的规格。来源：三星，ISSCC 2026
...
Samsung HBM4 Die Shots and Cross-Section. Source: Samsung, ISSCC 2026 三星 HBM4 模具喷头和横截面。来源：三星，ISSCC 2026
...
三星展示了一个 36 GB、12 高的 HBM4 堆栈，拥有 2048 个输入输出引脚和 3.3 TB/s 带宽，采用第六代 10nm 级（1c）DRAM 核心芯片，搭配 SF4 逻辑基模构建。
...
从 HBM3E 到 HBM4 最明显的架构变化是核心 DRAM 芯片和基础芯片之间的工艺技术。HBM4 仅使用 DRAM 工艺节点作为核心芯片，而基础芯片则采用先进的逻辑节点，这与之前几代 HBM 在两种芯片上使用相同工艺不同。
...
关键的架构挑战在于 AI 工作负载要求 HBM 提供更高的带宽和更快的数据速率。通过将基础芯片移至 SF4 逻辑工艺，三星实现了更高的运行速度和更低的功耗。工作电压（VDDQ）下降了 32%，从 HBM3E 的 1.1V 降至 HBM4 的 0.75V。基于逻辑的基极芯片相比 DRAM 工艺制造的基极芯片，晶体管密度更高，器件尺寸更小，面积效率更高，且晶体管更小且金属层堆叠容量更大。这帮助三星的 HBM4 实现并显著超越了我们在本节末尾详细解释的 JEDEC 的 HBM4 标准。
...
Samsung HBM4 Adaptive Body-Bias Control and Process Variation. Source: Samsung, ISSCC 2026 三星 HBM4 自适应体偏置控制与工艺变异。来源：三星，ISSCC 2026
...
结合自适应体偏置（ABB）控制，减少堆叠芯芯间的工艺差异，双倍 TSV 计数进一步提升了定时裕度。三星的论文称，ABB 和更高的 4×TSV 数使其 HBM4 能达到每脚最高 13 Gb/s 的运行速度。
...
We will be publishing a deep dive into the Maia 200, its microarchitecture and network topology, for institonal subscribers.
...
Hi **dahuir81@gmail.com**

## This post is for paid subscribers

[Already a paid subscriber? **Switch accounts**](https://substack.com/sign-in?redirect=%2Fp%2Fisscc-2026-nvidia-and-broadcom-cpo%3F_gl%3D1*19cc54k*_ga*MzYyNjY4NjIxLjE3NzQ0Mzk0ODQ.*_ga_FKWNM9FBZ3*czE3NzYyOTcyNzkkbzgkZzAkdDE3NzYyOTcyNzkkajYwJGwwJGgxODU4ODIyOTY1&for_pub=semianalysis&change_user=true)